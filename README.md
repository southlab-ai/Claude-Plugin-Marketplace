...
| **kg-educacion** | KG educativo privado e independiente — cinco tools MCP v3 para resolver OA y recuperar currículum y marcos de evaluación. Material access requires a user capability from an authorized consumer; an API key alone is insufficient. | 3.0.4 | Education |
